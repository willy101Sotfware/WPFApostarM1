...
namespace HantleDispenserAPI
{
    public class CDMS_Handler
    {
        ...
        {
            port = Convert.ToInt32(portname.ToUpper().Replace("COM", ""));
        ...
        private CDMS_Response SetParameters()
        {
            ...
            {
                AdminPayPlus.SaveLog("PeripheralController " + "SetParameters Catch" + $"FATAL: Ocurrió error de comunicación con el dispensador {ex.Message} " + ex);
        ...
        public CDMS_Response Initialize()
        {
            ...
            {
                AdminPayPlus.SaveLog("PeripheralController " + "Initialize Catch" + $"FATAL: Ocurrió error de comunicación con el dispensador {ex.Message} " + ex);
                return new CDMS_Response
                {
                    isSuccess = false,
                    ErrorCode = ErrorCDMS.RuntimeError,
        ...
        public CDMS_Response Dispense(int[] quantities)
        {
            try
            {
                ...
                for (int i = 0; i < quantities.Length; i++)
                {
                    CDMS_DenomInfo denomInfo = new CDMS_DenomInfo();
            ...
            {
                AdminPayPlus.SaveLog("PeripheralController " + "Dispense Catch" + $"FATAL: Ocurrió error de comunicación con el dispensador {ex.Message} " + ex);
                return new CDMS_Response
                {
                    isSuccess = false,
                    ErrorCode = ErrorCDMS.RuntimeError,
        ...
        public CDMS_Response Eject()
        {
            ...
            {
                AdminPayPlus.SaveLog("PeripheralController " + "Eject Catch" + $"FATAL: Ocurrió error de comunicación con el dispensador {ex.Message} " + ex);
                return new CDMS_Response
                {
                    isSuccess = false,
                    ErrorCode = ErrorCDMS.RuntimeError,
        ...
        public CDMS_Response GetSensor()
        {
            try
            {
                ...
                res.SensorInfo =new CDMS_SensorInfo();
            ...
            {
                AdminPayPlus.SaveLog("PeripheralController " + "GetSensor Catch" + $"FATAL: Ocurrió error de comunicación con el dispensador {ex.Message} " + ex);
                return new CDMS_Response
                {
                    isSuccess = false,
                    ErrorCode = ErrorCDMS.RuntimeError,
