...
namespace WPFApostar.Domain.Peripherals
{
    ...
    public class MeiAcceptor
    {
        ...
        {
            _isAvailable = true;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiStallResolved " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiStallResolved]}");
        }
        ...
        {
            _isAvailable = false;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiStallDetected " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiStallDetected]}");
        }
        ...
        private void MeiStackerFullResolved(object sender, EventArgs e)
        {
            ...
            AdminPayPlus.SaveLog("PeripheralController " + "MeiStackerFullResolved " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiStackerFullResolved]}");
        }
        ...
        private void MeiStackerFull(object sender, EventArgs e)
        {
            ...
            _isAvailable = false;
            _isStackerFull = true;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiStackerFull " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiStackerFull]}");
        }
        ...
        {
            AdminPayPlus.SaveLog("PeripheralController " + "MeiBillInEscrowOnPowerUp " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiBillInEscrowOnPowerUp]}");
        }
        ...
        {
            AdminPayPlus.SaveLog("PeripheralController " + "MeiPowerUpComplete " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiPowerUpComplete]}");
        }
        ...
        {
            AdminPayPlus.SaveLog("PeripheralController " + "MeiPowerUp " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiPowerUp]}");
        }
        ...
        {
            _isAvailable = true;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiPauseResolved " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiPauseResolved]}");
        }
        ...
        {
            _isAvailable = false;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiPauseDetected " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiPauseDetected]}");
        }
        ...
        {
            AdminPayPlus.SaveLog("PeripheralController " + "MeiDisconnected " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiDisconnected]}");
        }
        ...
        {
            AdminPayPlus.SaveLog("PeripheralController " + "MeiCheated " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiCheated]}");
        }
        ...
        {
            _isAvailable = true;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiJamResolved " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiJamResolved]}");
        }
        ...
        {
            _isAvailable = false;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiJamDetected " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiJamDetected]}");
        }
        ...
        private void MeiCashBoxAttached(object sender, EventArgs e)
        {
            ...
            AdminPayPlus.SaveLog("PeripheralController " + "MeiCashBoxAttached " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiCashBoxAttached]}");
        }
        ...
        private void MeiCashBoxRemoved(object sender, EventArgs e)
        {
            ...
            _isAvailable = !_isCashBoxRemoved;
            AdminPayPlus.SaveLog("PeripheralController " + "MeiCashBoxRemoved " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiCashBoxRemoved]}");
        }
        ...
        {
            AdminPayPlus.SaveLog("PeripheralController " + "MeiBillRejected " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiBillRejected]}");
        }
        ...
        private void MeiBillStacked(object sender, StackedEventArgs e)
        {
            try
            {
                ...
                AdminPayPlus.SaveLog("PeripheralController " + "MeiBillStacked " + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiBillStacked]} " + acep.Bill);
            ...
            catch (Exception ex)
            {
                ...
                AdminPayPlus.SaveLog("PeripheralController " + "MeiBillStacked  Catch" + $"Error Aceptador: Ocurrió un error en tiempo de ejecución: {ex.Message} " + ex);
            }
        }
        ...
        private void MeiConnected(object sender, EventArgs e)
        {
            try
            {
                ...
                AdminPayPlus.SaveLog("PeripheralController " + "MeiConnected" + $"Aceptador: {MeiMessagesHomologate[MeiMessages.MeiConnected]}");
            }
            catch (Exception ex)
            {
                AcceptorError.Invoke(ex);
                AdminPayPlus.SaveLog("PeripheralController " + "MeiConnected " + $"Error Aceptador: Ocurrió un error en tiempo de ejecución: {ex.Message} " + ex);
            }
        }
        ...
        public async Task<bool> OpenAcceptor(string meiPort)
        {
            ...
            {
                AcceptorError.Invoke(ex);
                AdminPayPlus.SaveLog("PeripheralController " + "OpenAcceptor Catch " + $"Error Aceptador: Ocurrió un error en tiempo de ejecución: {ex.Message} " + ex);
                return false;
            }
        }
        ...
        public bool EnableAcceptance()
        {
            try
            {
                ...
                AdminPayPlus.SaveLog("PeripheralController " + "EnableAcceptance " + $"Aceptador: Se ha iniciado la aceptación de Billetes");
                return true;
            }
            catch (Exception ex)
            {
                AcceptorError.Invoke(ex);
                AdminPayPlus.SaveLog("PeripheralController " + "EnableAcceptance Catch " + $"Error Aceptador: Ocurrió un error en tiempo de ejecución: {ex.Message} " + ex);
                return false;
            }
        }
        ...
        public void DisableAcceptance()
        {
            try
            {
                ...
                AdminPayPlus.SaveLog("PeripheralController " + "DisableAcceptance " + $"Aceptador: Se ha detenido la aceptación de Billetes");
            }
            catch (Exception ex)
            {
                AcceptorError.Invoke(ex);
                AdminPayPlus.SaveLog("PeripheralController " + "DisableAcceptance " + $"Error Aceptador: Ocurrió un error en tiempo de ejecución: {ex.Message} " + ex);
            }
        }
        ...
        public void CloseAcceptor()
        {
            ...
            {
                AcceptorError.Invoke(ex);
                AdminPayPlus.SaveLog("PeripheralController " + "CloseAcceptor Catch " + $"Error Aceptador: Ocurrió un error en tiempo de ejecución: {ex.Message} " + ex);
            }
        }
        #endregion
    }
