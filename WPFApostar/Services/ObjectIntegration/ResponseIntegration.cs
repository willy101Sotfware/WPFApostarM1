...
namespace WPFApostar.Services.ObjectIntegration
{
    ...
    //public class ResponseGetProducts
    //{
    //    public Empresafield empresaField { get; set; }
    //    public bool estadoField { get; set; }
    //    public Errorfield errorField { get; set; }
    //    public List<SubProductoGeneral> listadosubproductosField { get; set; }
    //}
    ...
    //{
    //    public float Codigoasesor { get; set; }
    //    public string Codigoseguridad { get; set; }
    ...
    //{
    //    public ApuestaNotifyR Apuesta { get; set; }
    //}
    ...
    //{
    //    public LoteriaNotifyR Loteria { get; set; }
    //}
    ...
    //public class ResponseNotifyPayment
    //{
    //    public int codigoseguridadField { get; set; }
    //    public Errorfield errorField { get; set; }
    //    public int transaccionidField { get; set; }
    //    public EmpresafieldNotify empresaField { get; set; }
    //    public bool estadoField { get; set; }
    //    public Jerarquiafield jerarquiaField { get; set; }
    //    public Listadomensajespublicitariosfield listadomensajespublicitariosField { get; set; }
    //    public Periodopagofield periodopagoField { get; set; }
    //}

    //public class EmpresafieldNotify
    //{
    //    public CiudadfieldNotify ciudadField { get; set; }
    //    public string direccionField { get; set; }
    //    public int nitField { get; set; }
    //    public string nombreField { get; set; }
    //    public int telefonoField { get; set; }
    ...
    //public class CiudadfieldNotify
    //{
    //    public int codigoField { get; set; }
    //    public DepartamentofieldNotify departamentoField { get; set; }
    //    public string nombreField { get; set; }
    //}

    //public class DepartamentofieldNotify
    //{
    //    public int codigoField { get; set; }
    //    public string nombreField { get; set; }
    //}

    //public class Jerarquiafield
    //{
    //    public int celulaidField { get; set; }
    //    public int ciudadidField { get; set; }
    //    public int departamentooidField { get; set; }
    //    public int empresaidField { get; set; }
    //    public int equipoidField { get; set; }
    //    public int oficinaidField { get; set; }
    //    public int paisidField { get; set; }
    //    public int puntoventaidField { get; set; }
    //    public int subzonaidField { get; set; }
    //    public int usuarioidField { get; set; }
    //    public int zonaidField { get; set; }
    //}

    //public class Listadomensajespublicitariosfield
    //{
    //    public object publicidadField { get; set; }
    //}

    //public class Periodopagofield
    //{
    //}
