...
namespace WPFApostar.UserControls.Betplay
{
    ...
    public partial class FinishUC : UserControl
    {
        ...
        public FinishUC(Transaction Ts)
        {
            InitializeComponent();
            Transaction = Ts;
        ...
        public void FinishTransaction()
        {
            try
            {
                ...
                Utilities.PrintBetplayP(Transaction);
        ...
        private async Task<bool> CalificacionCliente()
        {
            ...
            try
            {
                AdminPayPlus.SaveLog("FinishBetplayUC", "entrando a la ejecucion CalificacionCliente", "OK", "", Transaction);


                var respuesta = await AdminPayPlus.CalificacionCliente(Transaction);

                AdminPayPlus.SaveLog("FinishBetplayUC", "entrando a la ejecucion CalificacionCliente respuesta", "OK ", respuesta.ToString(), Transaction);
            ...
            {
                AdminPayPlus.SaveLog("FinishBetplayUC", "entrando a la ejecucion CalificacionCliente catch", "OK ", ex.Message, Transaction);
            }
            return false;
        }
