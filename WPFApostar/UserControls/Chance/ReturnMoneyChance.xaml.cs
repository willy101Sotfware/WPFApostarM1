...
{
    /// <summary>
    /// Lógica de interacción para ReturnMoneyChance.xaml
    /// </summary>
    public partial class ReturnMoneyChance : UserControl
    {
        ...
        public ReturnMoneyChance(Transaction transaction)
        {
        ...
        private async void OnCashDispensed(decimal totalDispensed, Dictionary<int, int> details)
        {
            ...
            {
                NotifyStatus = false;
                AdminPayPlus.SaveLog("ReturnMoneyChanceUC", "OnCashDispensed, el estado de la transaccion es Cancelada", "OK", "", transaction);
            ...
            {
                AdminPayPlus.SaveLog("ReturnMoneyChanceUC", "OnCashDispensed, el estado de la transaccion es Aprobado", "OK", "", transaction);
                NotifyStatus = true;
