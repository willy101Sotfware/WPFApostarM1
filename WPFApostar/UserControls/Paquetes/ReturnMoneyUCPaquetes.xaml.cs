...
namespace WPFApostar.UserControls.Paquetes
{
    ...
    /// </summary>
    public partial class ReturnMoneyPaquetesUC : UserControl
    {
        ...
        public ReturnMoneyPaquetesUC(Transaction transaction)
        {


            AdminPayPlus.SaveLog("ReturnMoneyPaquetesUC", "entrando al user control", "OK", "", transaction);
            ...
            {
                AdminPayPlus.SaveLog("ReturnMoneyPaquetesUC", "entrando al user control estado de transaccion", "OK", transaction.StatePay.ToString(), transaction);
        ...
        private async void OnCashDispensed(decimal totalDispensed, Dictionary<int, int> details)
        {
            ...
            {
                NotifyStatus = false;
                AdminPayPlus.SaveLog("ReturnMoneyUserControl", "OnCashDispensed, el estado de la transaccion es Cancelada", "OK", "", transaction);

                if (transaction.Payment.ValorDispensado < transaction.Payment.ValorIngresado)
                {
                    AdminPayPlus.SaveLog("ReturnMoneyUserControl", "OnCashDispensed, entrando a la condicion transaction.Payment.ValorDispensado < transaction.Payment.ValorIngresado", "OK", "", transaction);
                ...
                {
                    AdminPayPlus.SaveLog("ReturnMoneyUserControl", "OnCashDispensed, entrando a la condiciontransaction.Payment.ValorDispensado == transaction.Payment.ValorIngresado", "OK", "", transaction);
            ...
            {
                AdminPayPlus.SaveLog("ReturnMoneyUserControl", "OnCashDispensed, el estado de la transaccion es Aprobado", "OK", "", transaction);
                NotifyStatus = true;
                ...
                else if (transaction.Payment.ValorDispensado == transaction.Payment.ValorSobrante)
                {
                    ...
                    AdminPayPlus.SaveLog("ReturnMoneyUserControl", "OnCashDispensed, entrando a la condicion transaction.Payment.ValorDispensado == transaction.Payment.ValorSobrante", "OK", "", transaction);
