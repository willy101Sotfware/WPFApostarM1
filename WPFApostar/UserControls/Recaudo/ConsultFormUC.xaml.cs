...
{
    /// <summary>
    /// Lógica de interacción para ConsultFormUC.xaml
    /// </summary>
    public partial class ConsultFormUC : UserControl
    {
        ...
        public ConsultFormUC(Transaction Ts)
        {
            InitializeComponent();
            Transaction = Ts;
            ActivateTimer();
            ...
            try
            {
                ...
                switch (Transaction.ParametersCompany.Count())
                {
                    ...
                    case 2:
                        ...
                        Campo1.Visibility = Visibility.Hidden;
                        Campo4.Visibility = Visibility.Hidden;
                        Campo5.Visibility = Visibility.Hidden;                   
                        Input4.Visibility = Visibility.Hidden;
                        Input5.Visibility = Visibility.Hidden;
                        Campo2.Tag = Transaction.ParametersCompany[0].etiquetaField;
                        Campo3.Tag = Transaction.ParametersCompany[1].etiquetaField;
                        Data2.Text = Transaction.ParametersCompany[0].etiquetaField;
                        Data3.Text = Transaction.ParametersCompany[1].etiquetaField;
                        Data2.Tag = Transaction.ParametersCompany[0].tipodatoField;
                        Data3.Tag = Transaction.ParametersCompany[1].tipodatoField;
                        break;
                    case 3:
                        Input1.Visibility = Visibility.Hidden;
                        Campo1.Visibility = Visibility.Hidden;
                        ...
                        Data2.Text = Transaction.ParametersCompany[0].etiquetaField;
                        Data3.Text = Transaction.ParametersCompany[1].etiquetaField;
                        Data4.Text = Transaction.ParametersCompany[2].etiquetaField;
                        Data2.Tag = Transaction.ParametersCompany[0].tipodatoField;
                        Data3.Tag = Transaction.ParametersCompany[1].tipodatoField;
                        Data4.Tag = Transaction.ParametersCompany[2].tipodatoField;
                        Campo2.Tag = Transaction.ParametersCompany[0].etiquetaField;
                        Campo3.Tag = Transaction.ParametersCompany[1].etiquetaField;
                        Campo4.Tag = Transaction.ParametersCompany[2].etiquetaField;
                        break;
                    case 4:
        ...
        public bool Validate()
        {
            try
            {
                ...
                switch (Transaction.ParametersCompany.Count())
                {
                    ...
                    case 2:
                        if(!string.IsNullOrEmpty(Campo2.Text) && !string.IsNullOrEmpty(Campo3.Text))
                        {
                            return true;
                        }
                        ...
                        break;
                    case 3:
                        if (!string.IsNullOrEmpty(Campo2.Text) && !string.IsNullOrEmpty(Campo3.Text) && !string.IsNullOrEmpty(Campo4.Text))
                        {
                            return true;
                        }
                        break;
                    case 4:
                        if (!string.IsNullOrEmpty(Campo2.Text) && !string.IsNullOrEmpty(Campo3.Text) && !string.IsNullOrEmpty(Campo4.Text) && !string.IsNullOrEmpty(Campo1.Text))
                        {
                            return true;
                        }
                        break;
                    case 5:
                        if (!string.IsNullOrEmpty(Campo1.Text) && !string.IsNullOrEmpty(Campo2.Text) && !string.IsNullOrEmpty(Campo3.Text) && !string.IsNullOrEmpty(Campo4.Text) && !string.IsNullOrEmpty(Campo5.Text))
                        {
                            return true;
                        }
                        break;
